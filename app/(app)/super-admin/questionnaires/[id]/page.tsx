...
import { requireRolePage, writeAudit } from '@/lib/dal'
...
import { ConfirmModuleForm } from '@/app/(app)/admin/questionnaires/confirm-form'

export const metadata: Metadata = {
  title: 'Questionnaire result — Super Admin — Mission ON',
}
...
/**
 * SUPER_ADMIN classification detail (PRD §6.5 OUTPUT) — the super_admin mirror of
 * the admin detail. Shows the module code, confidence, flags and RAW responses,
 * and offers the divergence-confirm action. The data layer re-verifies the role
 * (is_admin_role covers super_admin); this page additionally writes a
 * classification.read audit entry (PRD §13) on each actual view.
 */
export default async function SuperAdminQuestionnaireDetailPage({
  params,
}: {
  ...
  // Audit the classification access (super_admin read a module code). PRD §13.
  await writeAudit({
