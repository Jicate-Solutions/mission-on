...
import { MentorActiveToggle } from '@/app/(app)/admin/mentors/mentor-active-toggle'

export const metadata: Metadata = { title: 'Mentors — Super Admin — Mission ON' }

// Per-user sensitive admin data: never cache.
export const dynamic = 'force-dynamic'

/**
 * Super Admin mentor directory — the super_admin mirror of the admin directory.
 * Reuses the admin-guarded queries (is_admin_role covers super_admin); real
 * identity is loaded only on the detail page. Page is double-gated: the
 * super-admin group layout + requireRolePage here + each query re-verifies.
 */
