...
import { getAdminQuestionnaireList } from './_data'
import { QuestionnaireStatusBadge } from '../../coordinator/questionnaires/status-badge'

export const metadata: Metadata = {
  title: 'Questionnaire results — Admin — Mission ON',
}
...
/**
 * ADMIN / SUPER_ADMIN classification results list. Shows the computed/confirmed
 * module code, confidence and divergence flag — visibility restricted to admins
 * at the data layer (getAdminQuestionnaireList re-verifies the role). PRD §7.3.
 */
                ...
                {rows.map((r) => (
                  <TableRow key={r.id}>
                    ...
                    <TableCell className="text-right">
                      <Link
                        href={`/admin/questionnaires/${r.id}`}
