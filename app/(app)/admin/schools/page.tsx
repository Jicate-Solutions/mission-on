...
/**
 * Admin/super_admin pipeline board: ALL schools, grouped by stage. The board is
 * classification-FREE (it shows pipeline progress + ownership only — module
 * codes live on the classification pages, not here).
 */
