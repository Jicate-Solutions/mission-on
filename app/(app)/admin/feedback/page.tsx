...
/**
 * Admin feedback overview. AGGREGATE / ANONYMIZED ONLY (Ring 2, PRD §12): counts,
 * averages, and a rating distribution. No per-learner row, comment, or identity
 * crosses to the admin on this path — getFeedbackAggregate() returns only
 * numbers. Allowed for admin + super_admin (group layout + this page-level gate).
 */
export default async function AdminFeedbackPage() {
  // Belt-and-braces: the admin group layout already gates this.
